...
python wf-attack-vpn/data_analysis/analyze_all_merged.py -d merged_traffic/mit/youtube -r overhead/youtube_10k
python wf-attack-vpn/data_analysis/analyze_all_merged.py -d merged_traffic/mit/vimeo   -r overhead/vimeo_10k  
python wf-attack-vpn/data_analysis/analyze_all_merged.py -d merged_traffic/mit/netflix -r overhead/netflix_10k

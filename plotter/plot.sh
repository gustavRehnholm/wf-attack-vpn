...
cp wf-result/twitch_rnd_100/twitch_rnd_2h/default.csv              wf-result/compare_100_default/rnd.csv
...
cp wf-result/twitch_rnd_100/twitch_rnd_2h/constant.csv              wf-result/compare_100_constant/rnd.csv
...
cp wf-result/twitch_rnd_100/twitch_rnd_2h/tiktok.csv              wf-result/compare_100_tiktok/rnd.csv

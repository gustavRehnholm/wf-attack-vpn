...
# merge 
python wf-attack-vpn/merge_traffic/main.py -f foreground_traffic -b background_traffic/twitch_50.h5 -m merged_traffic/test/twitch_50_1 --ffold 0 -w 1

# analysis
python wf-attack-vpn/data_analysis/merged-foreground-ratio.py -d merged_traffic/test/twitch_50_1

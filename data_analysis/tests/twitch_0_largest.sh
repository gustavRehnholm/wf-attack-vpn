...
# to run:
# ./wf-attack-vpn/data_analysis/tests/twitch_0_largest.sh
...
python wf-attack-vpn/data_analysis/foreground_cleaning.py -d merged_traffic/test/0/twitch_largest_2
python wf-attack-vpn/data_analysis/foreground_cleaning.py -d merged_traffic/test/0/twitch_largest_3
python wf-attack-vpn/data_analysis/foreground_cleaning.py -d merged_traffic/test/0/twitch_largest_4
python wf-attack-vpn/data_analysis/foreground_cleaning.py -d merged_traffic/test/0/twitch_largest_5
...
python wf-attack-vpn/plotter/plot_all.py --title twitch_largest_1 --input wf-result/test/0/twitch_largest_1 --output fig/twitch_0_largest
python wf-attack-vpn/plotter/plot_all.py --title twitch_largest_2 --input wf-result/test/0/twitch_largest_2 --output fig/twitch_0_largest
python wf-attack-vpn/plotter/plot_all.py --title twitch_largest_3 --input wf-result/test/0/twitch_largest_3 --output fig/twitch_0_largest
python wf-attack-vpn/plotter/plot_all.py --title twitch_largest_4 --input wf-result/test/0/twitch_largest_4 --output fig/twitch_0_largest
python wf-attack-vpn/plotter/plot_all.py --title twitch_largest_5 --input wf-result/test/0/twitch_largest_5 --output fig/twitch_0_largest
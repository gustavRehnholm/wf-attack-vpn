...
python wf-attack-vpn/train_test_combinations/combine_10fold_undef.py --app vimeo
python wf-attack-vpn/train_test_combinations/combine_10fold_undef.py --app netflix

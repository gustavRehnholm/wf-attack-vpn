#!/bin/bash
# To create all the combinations between the MIT streaming applications, and the Twitch dataset
...
python wf-attack-vpn/train_test_combinations/merged/combine_datasets.py --train merged_traffic/mit_5k/netflix --test merged_traffic/mit_5k/youtube --title netflix_youtube
